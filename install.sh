...
BUCKET_NAME="${ACCOUNT_ID}-${REGION}-kamn-serverless-workload"
...
elif aws s3 mb s3://${BUCKET_NAME}; then
...
echo "curl -X POST -H 'Content-Type: application/json' -d '${JSON_CONTENT}' ${REST_API_URL}/session/create"
